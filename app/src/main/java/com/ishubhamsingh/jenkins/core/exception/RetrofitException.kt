...
class RetrofitException internal constructor(
    ...
    enum class Kind {
        ...
        HTTP,
        /** An [NoConnectivityException] occurred while communicating to the network.  */
        CONNECTIVITY,
        /** An [AccountMismatchException] occurred.  */
        ACCOUNT,
        /**
    ...
    companion object {
        ...
        fun connectivityError(exception: NoConnectivityException): RetrofitException {
            return RetrofitException(exception.message, null, null, Kind.CONNECTIVITY, exception, null)
        }
