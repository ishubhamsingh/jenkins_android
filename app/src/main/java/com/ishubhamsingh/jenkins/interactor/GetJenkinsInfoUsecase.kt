...
class GetJenkinsInfoUsecase @Inject constructor(val preferences: Preferences) : UseCase<Pair<Int, Headers>, UseCase.None>() {

    var url: String = preferences.fetchString(Constants.KEY_URL)

    override suspend fun run(): Either<Failure, Pair<Int, Headers>> {
